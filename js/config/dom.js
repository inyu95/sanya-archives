export const dom = {
  ...
  toolbarNavActions: document.getElementById("toolbar-nav-actions"),
  toolbarMetaActions: document.getElementById("toolbar-meta-actions"),
  startupTimelineBtn: document.getElementById("startup-timeline-btn"),
  timelineModal: document.getElementById("timeline-modal"),
  timelineModalBackdrop: document.getElementById("timeline-modal-backdrop"),
  timelineModalClose: document.getElementById("timeline-modal-close"),
  timelineScroll: document.getElementById("timeline-scroll"),
  timelineScrollStage: document.getElementById("timeline-scroll-stage"),
  ...
  timelineZoomFit: document.getElementById("timeline-zoom-fit"),
